...
public interface YCSBEntity extends VanillaJavaApp {
    ...
    void fetchOutputs(@EffectorParam(name = "localpath", description = "the path to your local directory") String localpath, @EffectorParam(name = "workload", description = "the name to append to the fetched files") String workloadname);
